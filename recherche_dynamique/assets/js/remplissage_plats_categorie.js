...
// Get the category title based on the first plate's libelle
    ...
    categoryTitleElement.className = "col-sm-10 col-lg-4 fs-1 fw-medium ms-sm-0 ms-lg-3 mt-lg-3 lettres";
...
// div.appendChild(element_plat);
    ...
    commander_plat.href = "commande_json.html?id=" + plate.id_plat;
